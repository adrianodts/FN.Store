...
namespace FN.Store.Client.WCFApp.ClienteProxy {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="ClienteDTO", Namespace="http://schemas.datacontract.org/2004/07/FN.Store.Service.WCFApp.Models")]
    ...
    public interface IClienteService {
        ...
        FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO[] ObterTodos();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IClienteService/ObterTodos", ReplyAction="http://tempuri.org/IClienteService/ObterTodosResponse")]
        System.Threading.Tasks.Task<FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO[]> ObterTodosAsync();
        ...
        FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO ObterPorId(string id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IClienteService/ObterPorId", ReplyAction="http://tempuri.org/IClienteService/ObterPorIdResponse")]
        System.Threading.Tasks.Task<FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO> ObterPorIdAsync(string id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IClienteServiceChannel : FN.Store.Client.WCFApp.ClienteProxy.IClienteService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ClienteServiceClient : System.ServiceModel.ClientBase<FN.Store.Client.WCFApp.ClienteProxy.IClienteService>, FN.Store.Client.WCFApp.ClienteProxy.IClienteService {
        ...
        public FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO[] ObterTodos() {
            return base.Channel.ObterTodos();
        }
        
        public System.Threading.Tasks.Task<FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO[]> ObterTodosAsync() {
            return base.Channel.ObterTodosAsync();
        }
        
        public FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO ObterPorId(string id) {
            return base.Channel.ObterPorId(id);
        }
        
        public System.Threading.Tasks.Task<FN.Store.Client.WCFApp.ClienteProxy.ClienteDTO> ObterPorIdAsync(string id) {
